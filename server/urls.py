...
urlpatterns = [
    ...
    path('api/v1/quran_life_lessons/', include('Quran_Life_Lessons.urls')),
    path('api/v1/hadith_life_lessons/', include('Hadith_Life_Lessons.urls')),
    path('api/v1/life_lessons/', include('Life_Lessons.urls')),
